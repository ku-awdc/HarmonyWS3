...
You need to install R (version 4.2.0 or later) from https://cran.r-project.org/ as well as RStudio Desktop (version 2022.02.2 or later) from https://www.rstudio.com/products/rstudio/download/

Please also install the latest versions of the following R packages from CRAN:

```{r eval=FALSE}
install.packages(c("tidyverse", "PriorGen", "rjags", "runjags", 
                   "coda", "TeachingDemos"))
```
